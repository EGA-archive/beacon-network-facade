...
// In data I have all the info from the g_variant JSON
                ...
                <TableBody>
                  {row.history.map((historyRow) => (
                    <TableRow key={historyRow.date}>
                      ...
                      <TableCell>{historyRow.beaconName}</TableCell>
                      <TableCell>{historyRow.customerId}</TableCell>
                      <TableCell align="right">{historyRow.amount}</TableCell>
                      <TableCell align="right">{historyRow.response}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
      ...
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right"></TableCell>
            <TableCell align="right"></TableCell>
            <TableCell align="right">Allele Frequency</TableCell>
